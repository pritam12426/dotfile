...
ln -sf  "$DOT_FILE/dirwin_os/bashrc.bash"              "$HOME/.bashrc"
ln -sf  "$DOT_FILE/dirwin_os/zshrc.zsh"                "$HOME/.zshrc"
...
ln -sf  "$DOT_FILE/dirwin_os/config/navidrome"          "$HOME/.config/"
ln -sf  "$DOT_FILE/dirwin_os/config/ncdu"               "$HOME/.config/"
ln -sf  "$DOT_FILE/dirwin_os/config/npm"                "$HOME/.config/"
...
ln -sf  "$DOT_FILE/dirwin_os/config/ripgrep"            "$HOME/.config/"
ln -sf  "$DOT_FILE/dirwin_os/config/ruff"               "$HOME/.config/"
ln -sf  "$DOT_FILE/dirwin_os/config/ruff"               "$HOME/.config/"
ln -sf  "$DOT_FILE/dirwin_os/config/taplo"              "$HOME/.config/"
ln -sf  "$DOT_FILE/dirwin_os/config/tidy"               "$HOME/.config/"
...
ln -sf "$DOT_FILE/dirwin_os/bin/binary/fclones"          "$HOME/.local/bin/"
...
ln -sf "$DOT_FILE/dirwin_os/bin/binary/pstree"           "$HOME/.local/bin/"
ln -sf "$DOT_FILE/dirwin_os/bin/binary/tidy-html"        "$HOME/.local/bin/tidy"
ln -sf "$DOT_FILE/dirwin_os/bin/binary/tig"              "$HOME/.local/bin/"
ln -sf "$DOT_FILE/dirwin_os/bin/binary/tree"             "$HOME/.local/bin/"
ln -sf "$DOT_FILE/dirwin_os/bin/binary/typst-live"       "$HOME/.local/bin/"
